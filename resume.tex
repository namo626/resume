...
\begin{body}
  ...
  \begin{itemize}[leftmargin=*,topsep=0pt]
    ...
    \item Research areas: Simulation of coastal flooding, Numerical methods for shallow water flows
...
\noindent
  ...
  \begin{itemize}[leftmargin=*,topsep=0pt]
    \setlength\itemsep{-0.3em}
  \item Relevant coursework: Intro to HPC, Classical \& Quantum Mechanics, Scientific Programming, Discrete Algorithms, Object-Oriented Programming, Electromagnetism
  \end{itemize}
\end{body}
...
\begin{body}
  ...
  \item Partner with the Texas Water Development Board to determine worst-case scenario flood levels by running ADCIRC simulations on the Texas Advanced Computing Center (TACC) clusters for historical storms with extreme levels of surge or river discharge
  \item Prepared and validated compact finite element meshes of the Gulf of Mexico using OceanMesh2D and QGIS for use in multiple projects (including the ones above)
  \item Ported source code of the River Analysis System (HEC-RAS) from Windows to Linux using CMake as part of a code parallelization project with the US Army Corps of Engineers
  \end{itemize}
...
C/C\texttt{++}, Fortran (with MPI, OpenMP, PETSc), Python, MATLAB, Mathematica, Bash, HTML
\item \textbf{Tools:}
GNU/Linux, Git, GNU Make, CMake, LaTeX, QGIS, Tracker
\item \textbf{Research:}
Advanced Circulation model (ADCIRC), Figuregen, OceanMesh2D, FEniCS
\end{itemize}
...
\begin{body}
  \begin{itemize}[leftmargin=*]
    \setlength\itemsep{-0.3em}
  %\item {[Accepted for Nov 2022]} \textit{Numerical Simulation of Compound Flooding using Parametric Rainfall Models}. Young Coastal Scientists and Engineers Conference --- Americas. Pensacola, FL.
